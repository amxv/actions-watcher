...
help:
	@echo "actions-watcher command runner"
	@echo ""
	@echo "Targets:"
	...
	@echo "  make build        - build local binary to dist/actions-watcher"
	@echo "  make build-all    - build release binaries for 5 target platforms"
	@echo "  make install-local- install CLI to ~/.local/bin/actions-watcher"
